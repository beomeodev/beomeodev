...
| doit-n-live | Personal task-management system that unifies a Mandalart goal hierarchy, GTD capture/organize, the Eisenhower matrix, and execution tracking into a single pipeline. |
